...
const IcoFile = () => (
  <svg viewBox="0 0 24 24" style={{ width: 28, height: 28, fill: 'rgba(109,90,230,.50)' }}>
    ...
    >
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ fontWeight: 600, fontSize: 15, color: 'var(--text-primary)' }}>聊天文件</span>
          ...
          {items.map(item => (
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{
                  fontSize: 11.5, color: 'var(--text-tertiary)', marginTop: 3,
      ...
      {preview && (
        <ImagePreview src={preview.url} onClose={() => setPreview(null)} />
      )}
    </div>
  );
}
