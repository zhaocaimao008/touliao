...
> **2026-09-18 实物核验纠正：本文件是历史方案，不是已交付能力。** Windows 8.1.26 安装包和 Android 8.1.4–8.1.18、8.1.24 正式 APK 均没有本方案的资源/脚本加载器。整包更新应称为“应用内覆盖升级”，不是“半热更”或“真热更”。不要根据下面的理论能力表判断旧客户端已经支持热更新；以 [旧版安装包审计与验证记录](LEGACY-UPDATE-AUDIT-20260918.md) 为准。此处不授权迁移框架或发布过渡包。
