...
> **2026-09-18 实物核验：这份蓝图没有进入已发布的旧客户端。** 新增这里的 app.json 或 JS Bundle 地址不能让旧 Windows / Android 获得热更新能力。实际旧包协议、签名与安装验证见 [旧版审计](LEGACY-UPDATE-AUDIT-20260918.md)。本轮不据此迁移框架，也不自动发布过渡安装包。
